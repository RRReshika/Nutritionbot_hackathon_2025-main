...
export default function Home() {
  ...
  }>({ calories: null, foodName: '', answerType: 'general' });
  ...
  const handleCaloriesDetected = (calories: number | null, foodName: string, answerType?: 'myth' | 'fact' | 'general') => {
    const finalAnswerType = answerType || 'general';
    console.log(`🎯 Avatar state update: calories=${calories}, foodName=${foodName}, type=${finalAnswerType}`);
    setAvatarState({ 
      calories: calories, 
      foodName: foodName, 
        ...
        {showHomePage ? (
          ...
          <div className="panels-container">
            ...
            <VRMAvatar 
              isTyping={isTyping} 
              isWaving={isWaving}
              calories={avatarState.calories}
              foodName={avatarState.foodName}
              answerType={avatarState.answerType}
              myTake={myTake}
            />
